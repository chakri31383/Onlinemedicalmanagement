...
public class UserController {
    ...
    public String viewAppointments(Model model) {
        ...
        // Fetch appointments for the logged-in user (based on email)
        List<Appointment> appointments = appointmentServiceImplementation.findByEmail(admin.getEmail());

        // Add appointments to the model to display in the view
        model.addAttribute("appointments", appointments);
        return "user/appointments";
    }
	 @GetMapping("/edit-appointment/{id}")
	    public String editAppointment(@PathVariable("id") int id, Model model) {
	        Optional<Appointment> appointment = appointmentServiceImplementation.findById(id);
	        if (appointment.isPresent()) {
	            model.addAttribute("app", appointment.get());
	        } else {
	    ...
	    public String updateAppointment(@ModelAttribute("app") Appointment app) {
	    ...
	    public String deleteAppointment(@PathVariable("id") int id) {
	        appointmentServiceImplementation.deleteById(id);
	        return "redirect:/user/appointments";
	    }
